...
const EmailSection = () => {
  return (
    <section className='grid md:grid-cols-2 my-12 md:py-24 gap-4 relative'>
        <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -traslate-x-1/2 -translate-1/2'>
            {/* Purple Sphere */}
        </div>
      <div className="z-10">
      ...
      <div>
        <form className='flex flex-col gap-4'>
            ...
            <button type='submit' className='-mt-4 bg-purple-500 hover:bg-purple-600 text-white font-medium py-2.5 px-5 rounded-lg w-full'>Send Message</button>
        </form>
      </div>
    </section>
  )
